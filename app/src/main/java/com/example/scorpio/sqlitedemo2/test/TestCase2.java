package com.example.scorpio.sqlitedemo2.test;

import android.test.AndroidTestCase;
import android.util.Log;


import com.example.scorpio.sqlitedemo2.dao.PersonDAO2;
import com.example.scorpio.sqlitedemo2.db.PersonSQLiteOpenHelper;
